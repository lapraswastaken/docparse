...
class Matcher:
    ...
    r""" Each inner :class:`Matcher` :meth:`process`\\ es the entirety of the :attr:`match_pattern`'s match (:meth:`re.Match.group`). """
    ...
    def group(self):
        r""" Returns a :class:`Matcher` that has been added to the instance's list of :attr:`group_matchers`.
